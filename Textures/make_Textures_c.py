...
class Textures_C(ImageFolder):
    ...
    def __getitem__(self, index):
        ...
        output_path = os.path.join(self.output_dir,'images', os.path.relpath(path, self.dataset_folder))
...
if __name__ == '__main__':
    ...
    for level in range(5, 0, -1):
        for domain in corruption_dict.keys():
            dataset = Textures_C(root, domain=domain, level=level, output_dir='/data2/yongcan.yu/datasets/Textures-C',
